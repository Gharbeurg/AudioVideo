...
fichier_sortie_texte = "C:/PYTHON/.data/transcript.txt"            # sortie finale en phrases
fichier_sortie_segments = "C:/PYTHON/.data/transcript_segments.txt"  # sortie debug segments
